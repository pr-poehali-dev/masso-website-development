        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {[
            ...
            },
            {
              ...
              features: ["Всё из Базового", "Готовые протоколы и инструкции", "Обучение техникам продаж +25% конверсии", "Участие в вебинарах", "Закрытый чат с экспертами", "Поддержка 3 месяца"],
              accent: true,
              detailUrl: "/extended-package",
            },
            {
              name: "Полный",
              subtitle: "Максимум",
              features: ["Всё из Расширенного", "Обучение техникам продаж +25% конверсии", "Официальная сертификация", "Знак качества МассоПРО", "Размещение в каталоге студий", "Поддержка 6 месяцев"],
              accent: false,
              detailUrl: "/full-package",
            },
          ].map((pkg, i) => (
