    ...
    <FadeIn delay={delay ?? 0}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: "#aaa", marginBottom: 8 }}>
            {title}
          </div>
          <div style={{ fontFamily: "Cormorant, serif", fontSize: 24, fontWeight: 700, color: ACCENT, marginBottom: sub ? 6 : 0, lineHeight: 1.2 }}>
            {value}
          </div>
          {sub && (
    ...
    return (
      <div style={{ textAlign: "center", padding: "48px 24px" }}>
        ...
        <p style={{ fontSize: 16, color: "#5a5a5a", lineHeight: 1.65 }}>
          Мы ответим вам в течение рабочего дня. Обычно — быстрее.
        </p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div>
        ...
        <input
          value={name} onChange={e => setName(e.target.value)} placeholder="Мария Иванова" required
          style={inputStyle}
      ...
      <div>
        ...
        <input
          value={contact} onChange={e => setContact(e.target.value)} placeholder="+7 (___) ___-__-__ или email@mail.ru" required
          style={inputStyle}
          onFocus={e => (e.currentTarget.style.borderColor = ACCENT)}
          onBlur={e => (e.currentTarget.style.borderColor = "#e0e0e0")}
        />
      ...
      <button
        type="submit"
        style={{
          marginTop: 4, background: ACCENT, color: "#fff", padding: "15px 28px",
    ...
    <div style={{ background: "#f8f8f6", color: "#1a1a1a", fontFamily: "Montserrat, sans-serif", minHeight: "100vh" }}>
      ...
      <section style={{ paddingTop: 80, paddingBottom: 72 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          ...
          <FadeIn delay={100}>
            <h1 style={{
              fontFamily: "Cormorant, serif", fontSize: "clamp(40px, 5vw, 64px)",
              fontWeight: 700, lineHeight: 1.1, color: "#1a1a1a", marginBottom: 20, letterSpacing: "-0.5px",
            }}>
              Свяжитесь с нами
            </h1>
          </FadeIn>
          <FadeIn delay={200}>
            <p style={{ fontSize: 17, lineHeight: 1.75, color: "#5a5a5a", maxWidth: 560, margin: 0 }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
            ...
            <ContactCard
              icon="✈️"
              title="Telegram"
              value="@SergeuVodopianov"
              sub="Быстрый ответ"
              href="https://t.me/SergeuVodopianov"
              delay={200}
            />
            <ContactCard
              icon="🌐"
              title="Основной сайт"
              value="massopro.ru"
              sub="Вся информация о системе МассоПро"
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div style={{
            ...
            <div style={{ padding: "56px 48px" }}>
              <div style={{ fontFamily: "Cormorant, serif", fontSize: 30, fontWeight: 700, color: "#1a1a1a", marginBottom: 8 }}>
                Напишите нам
              </div>
              <p style={{ fontSize: 14, color: "#888", marginBottom: 32, lineHeight: 1.55 }}>
            ...
            {/* Right — info */}
            <div style={{ background: "#1a1a1a", padding: "56px 48px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                <div style={{ fontFamily: "Cormorant, serif", fontSize: 30, fontWeight: 700, color: "#fff", marginBottom: 8 }}>
                  Dok Диалог
                </div>
                    ...
                    <div key={i}>
                      ...
                      {item.href ? (
                        <a href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer"
                          style={{ fontSize: 16, color: "#fff", textDecoration: "none", transition: "color 0.2s" }}
                        ...
                        <div style={{ fontSize: 16, color: "#fff" }}>{item.value}</div>
                      )}
                    </div>
                  ))}
                </div>
